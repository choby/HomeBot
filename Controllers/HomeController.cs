...
namespace HomeBot.Controllers
{
    public class HomeController : Controller
    {
        ...
        string getMagnet()
        {
            ...
            //web.UserAgent = "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/77.0.3865.42 Safari/537.36 Edg/77.0.235.17";

            //web.CachePath = "/";
            //web.UseCookies = true;
            //web.UsingCache = true;
            //HtmlDocument doc = web.Load("http://gaoqing.la/cold-blood.html");
            //
